...
// Run function to stop note, if there is one
export const stopNoteOnKey = (state, key) => key.stopNote && key.stopNote()

export const playNoteOnKey = (state, key, extraFreqFactor=1) => {
  ...
  key.stopNote = stopNewNote
  setTimeout( () => stopNewNote(), noteLength * 1000)
